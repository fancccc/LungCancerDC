...
class DenseNet(torch.nn.Module):
    def __init__(self, layer_num=(6, 12, 24, 16), growth_rate=32, init_features=64, in_channels=8, middele_channels=128,
                 classes=2):
        """
...
if __name__ == '__main__':
    model = DenseNet(in_channels=8, classes=2)
    feat = torch.randn((1, 8, 768))
    out = model(feat)
    print(out.shape)
